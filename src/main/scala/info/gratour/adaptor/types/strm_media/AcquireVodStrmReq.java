...
public class AcquireVodStrmReq implements AcquireStrmReq {
    ...
    private byte mode;
    private byte factor;
    private EpochMillis startTime;
    private EpochMillis endTime;
    private int proto;
    ...
    public EpochMillis getStartTime() {
        return startTime;
    }

    public void setStartTime(EpochMillis startTime) {
        this.startTime = startTime;
    }

    public EpochMillis getEndTime() {
        return endTime;
    }

    public void setEndTime(EpochMillis endTime) {
