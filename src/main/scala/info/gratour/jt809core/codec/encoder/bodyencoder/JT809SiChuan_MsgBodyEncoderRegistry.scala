...
import info.gratour.jt809core.codec.encoder.bodyencoder.exg.{MBEncoder_1200_UpExgMsg_SiChuan, MBEncoder_9200_DownExgMsg}
import info.gratour.jt809core.codec.encoder.bodyencoder.jt1078.auth.MBEncoder_1700_UpAuthorizeMsg
import info.gratour.jt809core.codec.encoder.bodyencoder.jt1078.download.{MBEncoder_1B00_UpDownloadMsg, MBEncoder_9B00_DownDownloadMsg}
import info.gratour.jt809core.codec.encoder.bodyencoder.jt1078.filelist.{MBEncoder_1900_UpFileListMsg, MBEncoder_9900_DownFileListMsg}
import info.gratour.jt809core.codec.encoder.bodyencoder.jt1078.playback.{MBEncoder_1A00_UpPlaybackMsg, MBEncoder_9A00_DownPlaybackMsg}
import info.gratour.jt809core.codec.encoder.bodyencoder.jt1078.realvideo.{MBEncoder_1800_UpRealVideoMsg, MBEncoder_9800_DownRealVideoMsg}
...
import info.gratour.jt809core.codec.encoder.bodyencoder.warn.{MBEncoder_1400_UpWarnMsg_SiChuan, MBEncoder_9400_DownWarnMsg_SiChuan}

object JT809SiChuan_MsgBodyEncoderRegistry extends JT809MsgBodyEncoderRegistry {
  ...
  private val map: Map[Int, MsgBodyEncoder] = Seq(
    ...
    MBEncoder_1200_UpExgMsg_SiChuan,
    MBEncoder_9200_DownExgMsg,

    MBEncoder_1300_UpPlatformMsg,
    MBEncoder_9300_DownPlatformMsg,

    MBEncoder_1400_UpWarnMsg_SiChuan,
    MBEncoder_9400_DownWarnMsg_SiChuan,
    ...
    MBEncoder_1700_UpAuthorizeMsg,

    MBEncoder_1800_UpRealVideoMsg,
    MBEncoder_9800_DownRealVideoMsg,

    MBEncoder_1900_UpFileListMsg,
    MBEncoder_9900_DownFileListMsg,

    MBEncoder_1A00_UpPlaybackMsg,
    MBEncoder_9A00_DownPlaybackMsg,

    MBEncoder_1B00_UpDownloadMsg,
    MBEncoder_9B00_DownDownloadMsg,
