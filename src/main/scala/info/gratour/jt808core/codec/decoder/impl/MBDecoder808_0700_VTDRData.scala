...
import info.gratour.jt808core.protocol.msg.types.vtdr.{JT808VTDRDataBlock, JT808VTDR_AccidentPoints_10, JT808VTDR_DriveOverTime_11, JT808VTDR_DriverCardEvents_12, JT808VTDR_DriverInfo_01, JT808VTDR_Id_07, JT808VTDR_Locations_09, JT808VTDR_Mileage_03, JT808VTDR_PowerEvents_13, JT808VTDR_PulseFactor_04, JT808VTDR_RevEvents_14, JT808VTDR_SpdRecords_08, JT808VTDR_SpdStatusLog_15, JT808VTDR_StatusSignalConfig_06, JT808VTDR_Time_02, JT808VTDR_VehInfo_05, JT808VTDR_VerInfo_00, VTDRCmdConsts, VTDR_AccidentPoint, VTDR_CardEvent, VTDR_DriveOverTimeEntry, VTDR_Location, VTDR_LocationAndSpd, VTDR_LocationInfoPerHour, VTDR_LogRec, VTDR_PowerEvent, VTDR_RevEvent, VTDR_SpdAndStatus, VTDR_SpdLogEntry, VTDR_SpdRec, VTDR_Status}
  ...
  override def decodeMsgBody(m: JT808Msg_0700_VTDRData, body: ByteBuf, tempBuf: Array[Byte]): Unit = {
    ...
    val dataBlock: JT808VTDRDataBlock =
      cmd match {
        ...
        case _ =>
          throw new ErrorWithCode(Errors.BAD_FORMAT, s"Unsupported VTDR command: $cmd.")
      }
